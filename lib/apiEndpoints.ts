// API endpoint constants for Staycation Admin
// Update this file if endpoints change or new ones are added

export const ADMIN_API_ENDPOINTS = {
  LOGIN: "https://staycationhavenph.com/api/admin/login",
  ...
  DISCOUNTS: "https://staycationhavenph.com/api/admin/discounts"
};
