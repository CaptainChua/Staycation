...
export const createBooking = async (
  ...
  try {
    ...
    const body = await req.json();
    console.log("📥 createBooking body received:", JSON.stringify(body, null, 2));
    ...
    const paymentQuery = `
      INSERT INTO booking_payments (
        booking_id, payment_method, payment_proof_url, room_rate,
        add_ons_total, total_amount, down_payment, amount_paid, payment_status
      )
      VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
    `;
    ...
    const paymentValues = [
      ...
      down_payment,
      paymentAmountPaid,
      'approved_down_payment', // Set payment status so analytics can track revenue
    ];
