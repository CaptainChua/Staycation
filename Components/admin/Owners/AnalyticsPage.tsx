...
const AnalyticsPage = () => {
  ...
  const fetchAnalyticsData = async () => {
    try {
      ...
      if (!summaryData.success || !revenueData.success || !monthlyData.success) {
        setError(summaryData.error || revenueData.error || monthlyData.error || "Unable to load analytics data");
      }
