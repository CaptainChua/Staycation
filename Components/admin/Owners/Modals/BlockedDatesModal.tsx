      ...
      <div className="fixed inset-0 flex items-center justify-center p-2 sm:p-4" onClick={handleClose}>
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl h-[90vh] sm:h-auto sm:max-h-[90vh] border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden" onClick={(e) => e.stopPropagation()}>
          ...
          <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
            ...
            {/* Haven Selection */}
            <div>
              <label htmlFor="blocked-haven" className="block text-xs sm:text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label htmlFor="blocked-from-date" className="block text-xs text-gray-500 dark:text-gray-400 mb-1">From</label>
                  <input
                    id="blocked-from-date"
                    type="date"
                    value={fromDate}
                    onChange={(e) => setFromDate(e.target.value)}
                    className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-brand-primary focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                    required
                  />
                </div>
                <div>
                  <label htmlFor="blocked-to-date" className="block text-xs text-gray-500 dark:text-gray-400 mb-1">To</label>
                  <input
                    id="blocked-to-date"
                    type="date"
                    value={toDate}
            ...
            {/* Status */}
            <div>
              <label htmlFor="blocked-status" className="block text-xs sm:text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
