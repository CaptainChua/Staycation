...
const ReservationsPage = () => {
  ...
  const handleNewReservation = async (formData: any) => {
    try {
      console.log("📤 Sending booking data to API:", formData);
      
      // Call the createBooking mutation with the form data
      ...
      console.error("❌ Error creating reservation - Full Error Object:", error);
